    ...
    <div className="min-h-screen">
      ...
      <section className="relative max-w-6xl mx-auto px-4 pt-20 pb-16 text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight mb-4">
          Report Road Damage.
          <br />
          <span className="text-orange-400">Get It Fixed.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            to="/track"
            className="w-full sm:w-auto border border-slate-700 hover:border-slate-500 text-slate-300 hover:text-white font-medium px-8 py-3.5 rounded-xl text-base transition-colors"
          >
      ...
      <section className="max-w-6xl mx-auto px-4 pb-16">
        <div className="grid grid-cols-3 gap-4">
          {STATS.map((s) => (
            <div key={s.label} className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center">
      ...
      <section className="max-w-6xl mx-auto px-4 pb-24">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {HOW_IT_WORKS.map((item) => (
            <div
              key={item.step}
              className="bg-slate-800/30 border border-slate-700/50 rounded-xl p-6 flex gap-4 hover:border-slate-600 transition-colors"
            >
              ...
              <div>
                <div className="text-xs font-mono text-slate-500 mb-0.5">{item.step}</div>
